...
# 範例資料，模擬真實訂單系統裡會有的紀錄
_SEED_ORDERS = [
    ("A123451234", 2, "8月28日", "智慧掃地機器人 R5 Pro ×1"),
    ("B982311234", 0, "9月5日", "智慧冷氣 A8（1.5噸）×1"),
    ("C552101234", 3, "已送達", "智慧電視 V6 55吋 ×1"),
    ("D771021234", 1, "9月8日", "智慧掃地機器人 R5 Pro ×2、智慧電視 V6 43吋 ×1"),
    ("E300441234", 2, "9月4日", "智慧冷氣 A8（2.2噸）×1"),
]
